  ...
  return (
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/services/data-verification" element={<DataVerificationPage />} />
<Route path="/services/operational-standards" element={<OperationalStandardsPage />} /> 
<Route path="/services/scope-of-services" element={<ContactCenterProposalPage />} />
